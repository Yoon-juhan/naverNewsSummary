...
class Clustering:
    ...
    def addClusterNumber(article_df, vector_list):
        cluster_number_list = []
        ...
        article_df['cluster_number'] = cluster_number_list  # 군집 번호 칼럼 추가


    def getClusteredArticle(article_df): # 카테고리 별로 군집의 개수를 센다.
        ...
        for i in range(8):
            t = article_df[article_df['category'] == category_names[i]]['cluster_number'].value_counts().reset_index()
